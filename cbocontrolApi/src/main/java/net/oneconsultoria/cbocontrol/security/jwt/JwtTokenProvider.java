package net.oneconsultoria.cbocontrol.security.jwt;
...
import net.oneconsultoria.cbocontrol.exceptions.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    private DecodedJWT decodedToken(String token) throws Exception{
        try {
    ...
    public boolean validateToken(String token){
        ...
        try {
            ...
            throw new ResponseEntityExceptionHandler("Expired or invalid JWT token");
        }
    }
}
