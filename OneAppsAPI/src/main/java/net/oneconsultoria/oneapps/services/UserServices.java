...
import net.oneconsultoria.oneapps.controllers.UsuarioController;
import net.oneconsultoria.oneapps.data.vo.v1.UserVO;
...
public class UserServices implements UserDetailsService {
    ...
    public UserVO create(User usuarioNovo) throws Exception {
        ...
        usuarioNovo.setSenha(UtilsSecurity.convertPassword(usuarioNovo.getPassword()));
    ...
    public UserVO update(User usuarioAtualizacao) throws Exception {
        ...
        usuarioBanco.setNome(usuarioAtualizacao.getNome());
        ...
        if(usuarioAtualizacao.getPassword() != null && !usuarioAtualizacao.getPassword().isBlank())
            usuarioBanco.setSenha(UtilsSecurity.convertPassword(usuarioAtualizacao.getPassword()));
